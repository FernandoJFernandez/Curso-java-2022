...
public class Uso_Vehiculo {
	...
	public static void main(String[] args) {
		...
		//Coche Renault=new Coche();		//Instanciar clase. Ejemplar de clase
		
		//System.out.println("Este coche tiene " + Renault.ruedas + " ruedas.");	
		//System.out.println(Renault.dime_largo()); //Acceder a las propiedades del objeto a través de método
		...
		*/
		...
		//Instancias de la clase coche y de la clase furgoneta
		...
		System.out.println(mifurgoneta1.dime_datos_generales() + mifurgoneta1.dime_color() + mifurgoneta1.dimeDatosFurgoneta());
